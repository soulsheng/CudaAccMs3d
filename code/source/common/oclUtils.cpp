...
void oclPrintDevInfo(int iLogMode, cl_device_id device)
{
	...
	cl_ulong const_arg_size;
	clGetDeviceInfo(device, CL_DEVICE_MAX_CONSTANT_ARGS, sizeof(const_arg_size), &const_arg_size, NULL);
	shrLogEx(iLogMode, 0, "  CL_DEVICE_MAX_CONSTANT_ARGS:\t%u \n", const_arg_size );
